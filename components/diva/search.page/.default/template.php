...
define('IBLOCK_ID', 16);
?>
<?/*формируем $arResult дл€ поиска только в названи€х*/
...
<?/*формируем $arResult дл€ поиска c фото*/
			...
			<div class="item">
				<div class="company-standalone-container clear light-gray">
					...
					<div class="company-s-c-content">
							<span class="clist-date">—егодн€ 12:11</span>
							<h4>
								<a href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
							</h4>	
							<p class="clist-price"> 1 500 руб. </p>
							<?if (
							...
							<ul class="company-s-c-stats">
								<li class="add-to-favorite">
									<a>
										...
										<span class="already-in-text">”же в избранном</span>
										<span class="add-to-favorite-text">ƒобавить в избранное</span>
									</a>
								</li>
								<li>
									<i class="fa fa-eye"></i>
									<a href="">10 просмотров</a>
								</li>
							</ul>
					</div><!--class="company-s-c-content"-->	
